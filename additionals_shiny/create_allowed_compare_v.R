...
stations <- c("BaMet1998","BaMet2009","BaSoil1998","BaSoil2009","BaSoil2017",
            ...
            "SaSoil2002","SaSoil2012","SaMet2002","SaHole2006",
            "SaHole2010", "SaHole2018",
            "SaPond2006","SaPond2014","SaSnow2012","SaSnow2016",

            "TVCSoil2016")

sink("N:/sparc/LTO/R_database/Time_series_preprocessing/required-scripts-and-files/settings_shiny/allowedcompVariables.csv")
cat("dataset, variable\n")
for (i in stations) {
  hui <- list.files(paste0("N:/sparc/data/LTO/level0/", i, "/00_full_dataset/"), pattern = "lv0.dat")[1]
 # zack<-read.table(paste0("N:/geo5/SoilData/data/level1/",i,"/00_full_dataset/",hui),sep=",",dec=".",header=T)
  cnames <- colnames(read.table(paste0("N:/sparc/data/LTO/level0/", i,"/00_full_dataset/", hui), sep = ",", dec = ".", header = T))

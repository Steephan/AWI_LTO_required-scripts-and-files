...
############################################################################
# to run this script separately, you have to uncomment the next 15 lines!
rm(list = ls())
...
run.year <- c(2012:2020)#2020:aktuell
...
if (zack == 1) {
 #year = run.year
 db.snow <- read.table(paste(path$w[path$n == "LV1.p"], "SaSnow2012/00_full_dataset/SaSnow2012_", year, "_lv1_noflag.dat", sep = ""),
                       sep = ",", dec = ".", header = T, fill = TRUE)
 db.snow.lvl1 <- read.table(paste(path$w[path$n == "LV1.p"], "SaSnow2012/00_full_dataset/SaSnow2012_", year, "_lv1.dat", sep = ""),
                            sep = ",", dec = ".", header = T, fill = TRUE)
...
png(paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_airt_", year, ".png", sep = ""),
...
png(paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_sh_", year, ".png", sep = ""),
    width = p.width, height = p.height, pointsize = 8)
...
if (zack == 1) {
  ...
  png(file = paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_Ts_", year, ".png", sep = ""),
...
if (zack == 1) {
  ...
  png(paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_snowt_", year, ".png", sep = ""),
      width = p.width, height = p.height, pointsize = 8)
  par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  plot(as.numeric(strptime(db.snow.lvl1$UTC, format = "%Y-%m-%d %H:%M")),
...
if (zack == 1) {
 ...
 png(paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_rho_", year, ".png", sep = ""),
     width = p.width, height = p.height, pointsize = 8)
 par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
 plot(as.numeric(strptime(db.snow.lvl1$UTC, format = "%Y-%m-%d %H:%M")),
 ...
 png(paste(path$w[path$n == "plot.p"], year, "/SaSnow2012_wc_", year, ".png", sep = ""),
     width = p.width, height = p.height, pointsize = 8)
 par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
 plot(as.numeric(strptime(db.snow.lvl1$UTC, format = "%Y-%m-%d %H:%M")),

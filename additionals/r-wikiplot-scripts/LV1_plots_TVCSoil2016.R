...
###............................................................................
##
##  2021-05-11 SL adapted to runner app and git structure
...
#     didi <- read.table(paste0(p.1$w[p.1$n == "LV1.p"], "TVCSoil2016/00_full_dataset/TVCSoil2016_", kk, "_lv1_noflag.dat"),
#                        sep = ",", dec = ".", header = T, na.strings = "NA")
...
# 
#   png(file = paste(p.1$w[p.1$n == "plot.p"], "Longterm/TVCSoil2016_Ts_Longterm.png", sep = ""),
...
#   # horizontal sensors
# 
#   png(file = paste(p.1$w[p.1$n == "plot.p"], "Longterm/TVCSoil2016_vwc_h_Longterm.png", sep = ""),
#       width = 3600, height = 500, pointsize = 8)
#   par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
# 
...
#   # vertical sensors
# 
#   png(file = paste(p.1$w[p.1$n == "plot.p"], "Longterm/TVCSoil2016_vwc_v_Longterm.png", sep = ""),
#       width = 3600, height = 500, pointsize = 8)
#   par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
# 

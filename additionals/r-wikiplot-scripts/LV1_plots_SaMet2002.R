...
origin <- "1970-01-01"
years <- c(2002:2018) #2019:2020) # 2009:2016 2010:2016 2009 is produced by former scripts
# years  <- c(2015)
...
for (year_i in years) {
  if (zack == 1) {
    db.samet <- read.table(paste(path$w[path$n == "LV1.p"], "SaMet2002/00_full_dataset/SaMet2002_", year_i, "_lv1_noflag.dat", sep = ""), sep = ",", dec = ".", header = T, fill = TRUE)
    db.samet.lvl1 <- read.table(paste(path$w[path$n == "LV1.p"], "SaMet2002/00_full_dataset/SaMet2002_", year_i, "_lv1.dat", sep = ""), sep = ",", dec = ".", header = T, fill = TRUE)
    # db.lasyear_i <-read.table(paste(path$w[path$n=="LV1.p"],"SaMet2009/00_full_dataset/samet2009_",year_i-1,"_lv1.dat",sep=""),sep=",",dec=".",header=T, fill = TRUE)
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_albedo_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_pa_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    #  radiation Netto
    # -----------------------------------------------------
    net_zero <- which(db.samet.lvl1$NetRad_fl == 0)
    net_flags <- which(db.samet.lvl1$NetRad_fl > 0)



    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_rad_net_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    #  radiation Global
    # -----------------------------------------------------
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_rad_gl_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_rad_sw_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    plot(as.numeric(strptime(db.samet.lvl1$UTC, format = "%Y-%m-%d %H:%M")), db.samet.lvl1$SwOut,
      pch = 20, # cex.lab=1.7, cex.axis=1.5,   # albedo from file
      xlim = xxlim, ylim = c(-5, 720), xlab = " ", ylab = " ", xaxt = "n", yaxt = "n", type = "n", cex.axis = 3
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_rad_lw_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_Tair1_200_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_Tair2_200_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    ...
    dev.off()
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_Tair1_50_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    ...
    dev.off()
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_Tair2_50_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_prec_", year_i, ".png", sep = ""),
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_OLD_PREC_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    plot(as.numeric(strptime(db.samet.lvl1$UTC, format = "%Y-%m-%d %H:%M")), db.samet.lvl1$prec,
      pch = 20, # cex.lab=1.7, cex.axis=1.5,   # albedo from file
  ...
  if (zack == 1) {
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_wind_", year_i, ".png", sep = ""), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    ...
    png(paste(path$w[path$n == "plot.p"], year_i, "/SaMet2002_wrose_", year_i, ".png", sep = ""), width = p.width * 0.8, height = p.width * 0.8, pointsize = 8)
  ...
  if (zack == 1) {
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_RH_200_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_RH_50_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 1) {
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_Ts_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8) # ,A4, landscape)
    par(mar = c(1, 8, 1, 1), omi = c(0, 0, 0, 0))
  ...
  if (zack == 2) {
    ...
    png(paste0(path$w[path$n == "plot.p"], year_i, "/SaMet2002_wt_", year_i, ".png"), width = p.width, height = p.height, pointsize = 8) # ,A4, landscape)
